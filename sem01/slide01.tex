...
\begin{itemize}
    \item Comparação direta é propensa a erros, operações iguais em 32 bits e 64 bits podem ter resultados distintos, variações menores que o erro do ponto flutuante podem ser ignoradas pelo programa.
    \item O padrão IEEE-754 usado para representação de números em ponto flutuante gera imprecisão devido ao espaço limitado para tentar expressar números "ilimitados" (dízimas decimais).
\end{itemize}
